                ...
                >
                    ...
                    <div class="flex justify-between items-center mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                        <span class="inline-flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            @lang('admin::app.settings.data-transfer.tracker.live') &middot; <template v-if="jobInstance.type == 'import'">@lang('admin::app.settings.data-transfer.imports.import.pending-step-import')</template><template v-else>@{{ exportingFooterLabel }}</template>
                        </span>
                    </div>
                </div>
