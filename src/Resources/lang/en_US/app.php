    ...
    'shopify' => [
        ...
        'metafield' => [
            ...
            'index' => [
                ...
                'metaobject-definition' => 'Metaobject definition',
                'metaobject-credential' => 'Store credential',
                'metaobject-create-failed' => 'The metaobject definition could not be created. Please try again.',
                'metaobject-sync' => 'Sync to other stores',
                'metaobject-sync-title' => 'Sync metaobject definition',
                'metaobject-sync-select' => 'Select the stores to sync this definition to:',
                'metaobject-sync-update' => 'Update',
                'metaobject-sync-all-done' => 'This definition already exists on all other stores.',
                'metaobject-synced' => 'Synced',
                'metaobject-sync-failed' => 'Failed',
                'metaobject-source-missing' => 'No local mapping found for :type on the selected store. Save the mapping first.',
                'metaobject-create' => 'Create new',
                'metaobject-definition-name' => 'Name',
                'metaobject-field-label' => 'Field label',
                'metaobject-source' => 'Reference type',
                'metaobject-map-fields' => 'Map fields',
                'metaobject-map-title' => 'Map metaobject fields',
                'metaobject-unconstrained' => 'This reference is not linked to a specific metaobject definition.',
                'metaobject-product-categories' => 'From product categories',
                'metaobject-options' => 'Metaobject options',
                'metaobject-active-draft' => 'Active-draft status',
                'metaobject-translations' => 'Translations',
                'metaobject-online-store' => 'Publish entries as web pages',
                'metaobject-storefront-access' => 'Storefronts API access',
                'metaobject-customer-access' => 'Customer Account API access',
                'metaobject-add-field' => 'Add field',
                'metaobject-fields-required' => 'Add at least one field',
                'metaobject-manual-required' => 'A manual (non-SaaS) Shopify credential is required to create metaobjects',
