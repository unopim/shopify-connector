    ...
    'shopify' => [
        ...
        'credential' => [
            ...
            'index' => [
                ...
                'location_inventory_sync_note' => 'Bestandsaktualisierungen gelten nur für neu erstellte Produkte während der ersten Synchronisierung, nicht für spätere Aktualisierungen vorhandener Produkte.',
            ...
            'mapping' => [
                ...
                'collection' => [
                    ...
                    'errors' => [
                        ...
                        'image_skipped' => 'Sammlungsbild für Kategorie :code: übersprungen: Die Shop-URL ist nicht öffentlich erreichbar, daher kann Shopify sie nicht abrufen.',
                    ],
                    'images' => [
                ...
                'unit_price' => [
                    ...
                    'quantity_value_info' => 'Wählen Sie ein Attribut vom Typ Zahl, Dezimal oder Maßeinheit. Ein Maßeinheit-Attribut liefert auch die Einheit, sodass Sie die Mengeneinheit leer lassen können.',
                    'quantity_unit_info'  => 'Nur für ein Zahl- oder Dezimal-Wertattribut. Sein Wert muss einer gültigen Einheit entsprechen (z. B. :units); andere Werte werden nicht exportiert. Bei einem Maßeinheit-Attribut nicht erforderlich.',
        ...
        'metaobject' => [
            'title'      => 'Metaobjekt-Definitionen',
            'edit-title' => 'Metaobjekt bearbeiten',
            'general'    => 'Allgemein',
            'create'     => 'Metaobjekt erstellen',
            'create-new' => 'Neues Metaobjekt erstellen',
            'deleted'    => 'Metaobjekt gelöscht.',
            'save'       => 'Speichern',
            'cancel'     => 'Abbrechen',
            'back'       => 'Zurück',
            'delete'     => 'Löschen',
            ...
            'field-name'                 => 'Feldname',
            'field-type'                 => 'Typ',
            'field-single'               => 'Einzelwert',
            'field-list'                 => 'Listenwert',
            'field-child'                => 'Referenziertes Metaobjekt',
            'select'                     => 'Auswählen',
            'field-min'                  => 'Min',
            'field-max'                  => 'Max',
            'field-precision'            => 'Max. Dezimalstellen',
            'field-regex'                => 'Regex',
            'field-regex-preset'         => 'Regex-Vorlage',
            'field-choices'              => 'Auswahlmöglichkeiten (durch Komma getrennt)',
            'field-any-file'             => 'Beliebige Datei',
            'field-unit'                 => 'Einheit',
            'field-content-type'         => 'Inhaltstyp',
            'add-image'                  => 'Bild hinzufügen',
            'add-file'                   => 'Datei hinzufügen',
            'add-item'                   => 'Element hinzufügen',
            'add-field'                  => 'Feld hinzufügen',
            'name-required'              => 'Name ist erforderlich.',
            'fields-required'            => 'Fügen Sie mindestens ein Feld hinzu.',
            'edit-field'                 => 'Feld bearbeiten',
            'delete-field'               => 'Feld löschen',
            'field-saved'                => 'Feld gespeichert.',
            'field-deleted'              => 'Feld gelöscht.',
            'last-field'                 => 'Mindestens ein Feld ist erforderlich. Fügen Sie ein weiteres Feld hinzu, bevor Sie dieses löschen.',
            'options'                    => 'Metaobjekt-Optionen',
            'opt-active-draft'           => 'Aktiv-Entwurf-Status',
            'opt-translations'           => 'Übersetzungen',
            'opt-web-pages'              => 'Einträge als Webseiten veröffentlichen',
            'opt-storefront'             => 'Storefront-API-Zugriff',
            'opt-customer-account'       => 'Kundenkonto-API-Zugriff',
            'saved'                      => 'Metaobjekt gespeichert.',
            'credential'                 => 'Store',
            'entries'                    => 'Einträge',
            ...
            'link-text'                  => 'Linktext',
            'link-url'                   => 'Link-URL',
            'entry-empty'                => 'Noch keine Einträge.',
            'entry-saved'                => 'Eintrag gespeichert.',
            'entry-deleted'              => 'Eintrag gelöscht.',
            'entry-delete-confirm'       => 'Diesen Eintrag löschen?',
            'entry-code-required'        => 'Code ist erforderlich.',
            'invalid-url'                => 'Bitte geben Sie eine gültige URL ein.',
            'invalid-email'              => 'Bitte geben Sie eine gültige E-Mail-Adresse ein.',
            'entry-value-invalid'        => 'Bitte geben Sie einen gültigen Wert für :field ein.',
            'types'                      => [
                ...
                'image'                  => 'Bild',
                'video'                  => 'Video',
                'file_reference'         => 'Datei',
                'metaobject_reference'   => 'Metaobjekt-Referenz',
                'product_reference'      => 'Produktreferenz',
                'variant_reference'      => 'Variantenreferenz',
                'collection_reference'   => 'Sammlungsreferenz',
            ],
        ],
        'metafield' => [
            'datagrid' => [
                ...
                'metaobject-reference' => 'Metaobjekt-Referenz',
                'pin'                  => 'Pin',
            ],
            'index' => [
                ...
                'regex-preset'             => 'Gängige Muster für reguläre Ausdrücke',
                'regex-alphabetical'       => 'Alphabetische Zeichen',
                'regex-alphanumeric'       => 'Alphanumerische Zeichen',
                'regex-numeric'            => 'Numerische Zeichen',
                'regex-sku'                => 'SKU',
                'regex-placeholder'        => 'z. B. ^[a-zA-Z0-9]+$',
